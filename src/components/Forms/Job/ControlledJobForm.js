        ...
        <div>
          <label>
            <input
              ...
              value={formData["include_portfolio"]}
              onChange={(e) =>
                handleOnChange("include_portfolio", e.target.checked)
              }
            />
        ...
        <div>
          <label>
            <input
              ...
              name="include_social"
              id="include_social"
              value={formData["include_social"]}
              onChange={(e) =>
                handleOnChange("include_social", e.target.checked)
              }
            />
        ...
        {formData["include_portfolio"] && (
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleOnChange("portfolio_links", e.target.value)
              }
            />
          </div>
        )}
        {formData["include_social"] && (
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleOnChange("social_media_links", e.target.value)
              }
            />
          </div>
        )}
